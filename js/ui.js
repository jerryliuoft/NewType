...
function CreateUI (game, player){
	...
	buttonjump = game.add.button(260, 10, 'buttona', null, this, 0, 1, 0, 1);  //game, x, y, key, callback, callbackContext, overFrame, outFrame, downFrame, upFrame
    ...
    createSlider(game, 300, 200, player);
}
